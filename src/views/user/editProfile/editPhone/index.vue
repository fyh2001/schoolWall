<!--
 * @Author: 黄叶
 * @Date: 2023-06-12 11:35:11
 * @LastEditTime: 2023-06-12 19:01:35
 * @FilePath: /schoolWall/src/views/user/editProfile/editPhone/index.vue
 * @Description: 
-->
<template>
    ...
    <div class="py-3 px-4 w-full bg-white border-b-0.5 overflow-hidden z-999">
      <div class="flex items-center">
        ...
        />
        <div>
          <div class="text-4.8 text-gray-5 font-bold">修改手机号</div>
        </div>
      </div>
    </div>
